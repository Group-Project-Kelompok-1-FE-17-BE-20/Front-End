...
function Cart() {
  ...
  useEffect(() => {
    axios
      .get<CartState>(
        'https://65acaf53adbd5aa31bdf714f.mockapi.io/Keranjang',
      )
      .then((response: AxiosResponse<CartState>) => {
    ...
    <div>
      ...
      <section className='w-full mx-auto lg:flex-1 px-[38px] py-[15px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-md max-w-none lg:max-w-[1404px] mb-10 mt-10'>
        <div className='flex-col justify-start items-center gap-[30px] flex'>
          <div className='text-center text-zinc-700 text-[46px] font-semibold font-poppins'>
            Keranjang Kamu
          </div>
        </div>
          ...
          <div className='w-full min-w-0 xl:min-w-[715px] space-y-6'>
            {cartItems.map(
              ({
                ...
                <div
                  key={product_id}
                  className='w-full h-[188px] px-6 py-5 bg-white rounded-[20px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] flex-col justify-start items-start gap-6 inline-flex '
                >
                  <div className='self-stretch justify-start items-center gap-4 inline-flex'>
                    <div className='w-[124px] h-[124px] pl-[13px] pr-[13.07px] bg-zinc-100 rounded-lg justify-center items-center flex'>
                      <img
                        className='w-[97.93px] h-[146.50px]'
                        ...
                        <div className='flex-col justify-start items-start gap-0.5 flex'>
                          ...
                          <div className='flex-col justify-start items-start gap-1 flex'>
                            <div>
                              ...
                              <span className='text-black text-opacity-60 text-sm font-normal font-poppins'>
                                Rp {formatToIDR(harga_satuan)}
                              </span>
                            </div>
                          </div>
                        </div>
                        <div className='text-orange-400 text-2xl font-semibold font-poppins'>
                      ...
                      <div className='w-[225px] h-[124px] flex-col justify-between items-end inline-flex'>
                        <div className='h-6 justify-start items-start gap-4 inline-flex'>
                          ...
                          <svg
                            ...
                            viewBox='0 0 24 25'
                            fill={
                              checkedItems.has(product_id) ? '#0396C7' : 'none'
                            }
                            xmlns='http://www.w3.org/2000/svg'
          ...
          <div className='w-full min-w-0 xl:min-w-[505px] px-6 py-5 bg-white rounded-[20px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] flex-col justify-start items-start gap-6 inline-flex h-min'>
            ...
            <div className='self-stretch  flex-col justify-start items-start gap-5 flex'>
              {finalOrder.items.map(
                ({ product_id, total_harga, nama_produk, jumlah }) => (
                  <div
                    key={product_id}
                  ...
                  >
                    ...
                    <div className='text-right text-zinc-800 text-xl font-semibold font-poppins'>
                      Rp {formatToIDR(total_harga)}
                    </div>
                  </div>
                ),
              ...
              <div className='self-stretch justify-between items-center inline-flex'>
                ...
                <div className='text-right text-zinc-800 text-2xl font-semibold font-poppins'>
