                    ...
                    <defs>
                        <clipPath id='clip0_26_306'>
                            <rect
                                ...
                                height='16'
                                fill='white'
                                transform='translate(0 0.976196)'
                            />
                        </clipPath>
                    </defs>
                </svg>
                        ...
                        <aside className='w-full lg:w-1/5 px-4 py-6 shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-md min-w-[309px] max-w-none lg:max-w-[309px] h-min'>
                            <ul className='space-y-4 lg:space-y-10'>
                                {menuItems.map(({ svg, title, subtitle, id }) => (
                                    <li
                                        key={id}
                                        className={`${activeItem === id ? 'bg-[#0396C7]' : 'bg-[#D0E9FEB2]'
                                            } rounded-md flex px-3 py-2 items-center gap-3 cursor-pointer`}
                                        onClick={() => handleMenuItemClick(id)}
                                    >
                                        <div
                                            className={`${activeItem === id ? 'bg-white' : 'bg-[#0396C7]'
                                                } p-2 rounded-full`}
                                        >
                                            {svg}
                                        </div>
                                        <div className='flex flex-col'>
                                            <h4
                                                className={`${activeItem === id ? 'text-white' : 'text-[#0396C7]'
                                            ...
                                            <p
                                                className={`${activeItem === id ? 'text-white' : 'text-[#0396C7]'
                                                    } font-poppins font-normal text-[10px]`}
                                            >
                                                {subtitle}
                                            </p>
                                        </div>
...
function MyProducts() {
    ...
    return (
        <section className='w-full lg:flex-1 px-[38px] py-[15px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-md max-w-none lg:max-w-[749px] mb-8'>
            <h2 className='font-poppins text-2xl font-semibold text-[#111827] mb-[12px]'>
                Tambah Produk Baru
            </h2>
            ...
            <form onSubmit={handleSubmit}>
                <AccordionItem
                    ...
                    sub='Untuk mulai berjualan, yang Anda perlukan hanyalah nama dan harga.'
                    alwaysOpen
                    required
                >
                    <div className='mb-6'>
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                            <div>
                                <label
                                    htmlFor='NamaProduk'
                                    className='block mb-2 text-sm font-medium text-[#6B7280]'
                                >
                        ...
                        <div className='font-poppins text-sm font-normal text-[#6B7280] mt-2'>
                            ...
                            <p>
                                50-60 karakter adalah panjang yang direkomendasikan untuk mesin
                                pencari.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                        <div className='mb-6'>
                            <label
                                htmlFor='Kategori'
                                className='mb-2 text-sm font-medium text-[#6B7280] flex items-center gap-2'
                            >
                                Kategori
                                <span>
                                    <svg
                ...
                <AccordionItem title='Variasi'>Variasi</AccordionItem>
                <AccordionItem title='Media'>Media</AccordionItem>

                <div className='flex justify-center mt-3'>
                    <button
                        type='submit'
                        className='text-white bg-[#0396C7] focus:ring-4 font-poppins font-medium rounded-lg text-base px-16 py-4 text-center'
                    >
                        Tambah Produk
                    </button>
                </div>
