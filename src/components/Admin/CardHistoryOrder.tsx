      ...
      <div className="flex flex-col gap-3  bg-[#F0F8FF]">
        <div className="flex flex-col">
          <div className="flex flex-col p-3">
            ...
            <div className="div md:flex-row flex flex-col p-3 gap-5">
              <div className="h-[10vh] md:h-auto hidden md:block">
              ...
              <div className="flex md:w-[45%] flex-col md:gap-5 gap-2 items-start">
