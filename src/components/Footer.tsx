function Footer() {
  return (
    <div className='w-full min-h-[552px] px-10 py-8 bg-sky-50 flex justify-center items-center'>
          ...
          <div className='flex flex-wrap justify-start items-start gap-8'>
            <div className='flex flex-col justify-start items-start gap-4'>
              ...
              <div className='flex-col justify-start items-start gap-2 flex'>
                <div className='text-gray-500 text-sm font-medium font-poppins tracking-wide'>
                  Tentang StoreID
                </div>
                <div className='text-gray-500 text-sm font-medium font-poppins tracking-wide'>
                  Kebijakan StoreID
            ...
            <div className='flex-col justify-start items-start gap-4 inline-flex'>
              <div className='text-gray-800 text-sm font-semibold font-poppins uppercase tracking-wide'>
                Bantuan & dukungan
              </div>
              <div className='flex-col justify-start items-start gap-2 flex'>
                <div className='text-gray-500 text-sm font-medium font-poppins tracking-wide'>
          ...
          <div className='flex flex-wrap justify-start items-start gap-8 md:block'>
            ...
            <div className='flex-col justify-start items-start gap-[18px] flex'>
              <div className='flex-col justify-start items-start gap-[5px] flex'>
                <div className='text-gray-800 text-sm font-medium font-poppins tracking-wide'>
                ...
                <div className='justify-start items-start gap-2 inline-flex'>
                  ...
                  <div className='px-[30px] py-[13px] bg-sky-600 rounded-lg justify-start items-start gap-2.5 flex'>
                    <div className='text-white text-sm font-semibold font-poppins uppercase tracking-wide'>
                      Bergabung
                    </div>
                  </div>
                </div>
              ...
              <div>
                <span className='text-gray-500 text-xs font-medium font-poppins tracking-wide'>
                  Dengan mengklik tombol BERLANGGANAN, Anda menyetujui{' '}
                </span>
                <span className='text-sky-900 text-xs font-medium font-poppins tracking-wide'>
          ...
          <div className='flex flex-col justify-start items-start gap-6'>
            ...
            <div className='flex-col justify-start items-start gap-4 flex'>
              <div className='justify-start items-center gap-[7px] inline-flex'>
                <div className='text-gray-500 text-sm font-medium font-poppins underline tracking-wide'>
                  Privacy Center
                </div>
                <div className='text-gray-500 text-sm font-medium font-poppins underline tracking-wide'>
