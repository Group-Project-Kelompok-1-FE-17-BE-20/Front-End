...
const Header: FC = () => {
  ...
  return (
    <div id="headerContainer" className="flex justify-between fixed z-10 w-screen items-center px-12 md:px-28 py-2 md:py-0 bg-white shadow-sm h-[20vh]">
      <h2 id="storeTitle" className="text-2xl md:text-4xl font-bold text-[#0396C7]">
        StoreID
      </h2>

      <div id="headerItems" className="flex items-center gap-2 md:gap-10">
        <div id="additionalItems" className="items-center justify-end gap-5 flex">
          {username !== "admin" && (
            <p id="productLink" className="font-poppins font-normal text-lg hidden lg:block font-Poppins text-[#828282] cursor-pointer" onClick={() => navigate("/")}>
              Product
            </p>
          )}
          ...
          {username === "admin" ? (
            ...
            <svg id="cartIcon" onClick={() => navigate("/cart")} className="cursor-pointer" width="28" height="26" viewBox="0 0 28 26" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            <span id="signupLink" onClick={() => navigate("/register")} className="md:mr-[10vw] mr-0 underline text-sm lg:text-lg font-bold text-[#0396C7] cursor-pointer">
              Sign Up
            </span>
          )}
        </div>
          ...
          <div id="adminMenu" className="bg-white ease-in duration-1000 transition-all p-4 absolute top-[20vh] right-[7rem] border-[1.2px] shadow-md w-[18vw]">
            <div className="flex flex-col items-center justify-center">
              <div className="flex flex-col justify-center items-start w-full gap-3">
                <button id="daftarUserBtn" onClick={() => navigate("/daftar-users")} className="text-[#828282] hover:text-[#0396C7] flex items-center gap-3 w-full">
                ...
                <button id="daftarTransaksiBtn" onClick={() => navigate("/history-order/users")} className="text-[#828282] hover:text-[#0396C7] flex items-center gap-3 w-full">
                ...
                <button id="logoutBtn" onClick={logOut} className="text-[#828282] hover:text-[#0396C7] flex items-center gap-3 w-full">
        ...
        {username !== "admin" && showHamMenu && (
          <div id="nonAdminMenu" className="bg-white ease-in duration-1000 transition-all p-4 absolute top-[20vh] right-[7rem] border-[1.2px] shadow-md w-[15vw]">
            <div className="flex flex-col items-center justify-center">
              <div className="flex flex-col justify-center items-start w-full gap-3">
                <button id="profilSayaBtn" onClick={() => navigate("/profilsaya")} className="text-[#828282] hover:text-[#0396C7] flex items-center gap-3 w-full">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M5.3163 19.4384C5.92462 18.0052 7.34492 17 9 17H15C16.6551 17 18.0754 18.0052 18.6837 19.4384M16 9.5C16 11.7091 14.2091 13.5 12 13.5C9.79086 13.5 8 11.7091 8 9.5C8 7.29086 9.79086 5.5 12 5.5C14.2091 5.5 16 7.29086 16 9.5ZM22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z"
                      stroke="#272D2F"
                ...
                <button id="logoutNonAdminBtn" onClick={logOut} className="text-[#828282] hover:text-[#0396C7] flex items-center gap-3 w-full">
                  <svg width="20" height="20" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M12.56 2.44L11.11 3.89C11.9912 4.42057 12.7203 5.16984 13.2266 6.06515C13.733 6.96046 13.9994 7.97142 14 9C14 10.5913 13.3679 12.1174 12.2426 13.2426C11.1174 14.3679 9.5913 15 8 15C6.4087 15 4.88258 14.3679 3.75736 13.2426C2.63214 12.1174 2 10.5913 2 9C2 6.83 3.16 4.94 4.88 3.88L3.44 2.44C2.3779 3.17279 1.50984 4.15277 0.910579 5.29555C0.311319 6.43832 -0.00117702 7.70963 3.33137e-06 9C3.33137e-06 11.1217 0.842858 13.1566 2.34315 14.6569C3.84344 16.1571 5.87827 17 8 17C10.1217 17 12.1566 16.1571 13.6569 14.6569C15.1571 13.1566 16 11.1217 16 9C16 6.28 14.64 3.88 12.56 2.44ZM9 0H7V10H9"
                      fill="#272D2F"
        ...
        {username && (
          <div id="userProfile" className="flex items-center gap-2 md:gap-5">
            <p id="usernameText" className="text-base md:text-xl font-medium text-[#0396C7]">
              {username}
            </p>
            <img id="profileImage" onClick={() => setShowHam(!showHamMenu)} className="cursor-pointer rounded-full w-8 h-8 md:w-12 md:h-12 object-cover" src="https://via.placeholder.com/50x50.png/000000?text=." alt="profile" />
          </div>
        )}
      </div>
    </div>
