    ...
    <>
      ...
      <div id="main-container" className="flex flex-col pt-44 gap-8 font-Poppins">
        ...
        <div id="content" className="flex justify-center items-center">
          <div id="orders-container" className="flex flex-col gap-5 mb-20 border-2 border-slate-50 md:p-5 p-2 overflow-y-scroll w-[90vw] h-[60vh]">
            <div id="search-container" className="md:p-3 p-1 flex w-full border-[1.5px] gap-1 md:gap-3">
              <div id="search-input" className="flex justify-center items-center gap-2 border-[1.5px] w-[80%] rounded-md bg-[#F5F5F5]">
                ...
                <input id="search-input-box" type="text" className="w-full py-2 px-3 bg-[#F5F5F5]" placeholder="Cari Pesanan" />
              </div>
              <button id="search-button" className="md:px-5 md:py-2  text-xs md:text-base rounded-md border-[#0396C7] border-[1.5px] ">
                No Pesanan
              </button>
            </div>
            <CardHistoryOrder />
